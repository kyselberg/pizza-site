<template>
  <div class="sort">
    <div class="sort__label" @click="changeIsVisible">
      <svg
...
<script>
import { SORT_ACTION } from '@/store/constants'
...
export default {
  ...
  methods: {
    chooseThis(item) {
      ...
      this.$store.dispatch(SORT_ACTION, item.type)
    },
    changeIsVisible() {
